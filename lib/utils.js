 ...
 * @property {Number} createTimeout=500
 * @property {Number} destroyTimeout=500
 */
...
exports.validateOptions = function(opts, isPool) {
  ['min', 'max', 'createTimeout', 'destroyTimeout'].forEach(function(prop) {
    if (typeof opts[prop] !== 'number' || opts[prop] < 1) {
      delete opts[prop]
    }
  })
  ...
  var merged = extend(defaultOpts, opts)
