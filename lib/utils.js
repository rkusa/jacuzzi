 ...
 * @property {Number} leakDetectionThreshold=0 This property controls the amount
 *           of time that a resource can be in use out of the pool before a error
 *           is thrown indicating a possible resource leak. (0 = disabled)
 */
